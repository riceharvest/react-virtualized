...
import DynamicWidthGrid from './CellMeasurer.DynamicWidthGrid.example.jsx';
import DynamicHeightGrid from './CellMeasurer.DynamicHeightGrid.example.jsx';
import DynamicWidthMultiGrid from './CellMeasurer.DynamicWidthMultiGrid.example.jsx';
import DynamicHeightList from './CellMeasurer.DynamicHeightList.example.jsx';
import DynamicHeightTableColumn from './CellMeasurer.DynamicHeightTableColumn.example.jsx';
  ...
  render() {
    ...
    return (
      <ContentBox>
        <ContentBoxHeader
          text="CellMeasurer"
          sourceLink="https://github.com/bvaughn/react-virtualized/blob/master/source/CellMeasurer/CellMeasurer.example.jsxx"
